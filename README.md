...
전주에서 출발하는 국내 소도시 여행을 여행지별로 계획하고 관리하는 개인용 웹앱입니다. Firestore의 국내여행 전용 영역과 브라우저의 `localStorage`에 내용을 함께 저장합니다.
...
- 수정 모드에서 당일치기부터 최대 13박 14일까지 여행 기간을 조절하고 일정·가계부 일차를 자동 구성
